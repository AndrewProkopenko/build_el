...
btnPlain.forEach( (item, i) => {  
       btnPlain[i].addEventListener('mousemove', () => { 
           Plain[i].classList.add('start') 
       })
       btnPlain[i].addEventListener('mouseleave', () => { 
...
let serviceBtn = document.querySelector('.js-service-btn'),
    ...
    flag = 0; 
let countServiceItem = 8; 

if(window.innerWidth > 992 ) countServiceItem = 9; 
